...
static const uint8_t LUT_SIZE_TTGO_V231 = 154;

static const uint8_t FULL_UPDATE_LUT_TTGO_V231[LUT_SIZE_TTGO_V231] = {
...
static const uint8_t PARTIAL_UPDATE_LUT_TTGO_V231[LUT_SIZE_TTGO_V231] = {
...
void WaveshareEPaperTypeA::dump_config() {
  ...
  switch (this->model_) {
    ...
    case TTGO_EPAPER_2_13_IN_B73:
      ...
      break;
    case TTGO_EPAPER_2_13_IN_V231:
      ESP_LOGCONFIG(TAG, "  Model: 2.13in (TTGO V231)");
      break;
    case TTGO_EPAPER_2_13_IN_B1:
...
void HOT WaveshareEPaperTypeA::display() {
    ...
    if (full_update != prev_full_update) {
      switch (this->model_) {
        ...
        case TTGO_EPAPER_2_13_IN_B73:
          ...
          break;
        case TTGO_EPAPER_2_13_IN_V231:
          this->write_lut_(full_update ? FULL_UPDATE_LUT_TTGO_V231 : PARTIAL_UPDATE_LUT_TTGO_V231, LUT_SIZE_TTGO_V231);
          break;
        case TTGO_EPAPER_2_13_IN_B1:
  ...
  if (this->model_ == WAVESHARE_EPAPER_2_9_IN_V2 || this->model_ == WAVESHARE_EPAPER_1_54_IN_V2) {
    ...
    this->data(0xC7);
  } else if (this->model_ == TTGO_EPAPER_2_13_IN_V231) {
    this->data(0xC0);
  } else {
    this->data(0xC4);
  }
